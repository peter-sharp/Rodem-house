...
class DatabaseBuilder extends DatabaseHelper {
	/**
    ...
    */
  protected function querySqlQue ($sqlQueries) {
    foreach($sqlQueries as $sql){
			try {
      	$query = $this->queryRow($sql);
				if ($query)
...
DatabaseBuilder::injectMysqli($mysqliConnector->getConnection());
